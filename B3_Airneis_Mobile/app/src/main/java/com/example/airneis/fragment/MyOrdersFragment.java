...
public class MyOrdersFragment extends Fragment {
    ...
    private List<Order> parseOrders(JSONArray ordersArray) throws JSONException {
        ...
        for (int i = 0; i < ordersArray.length(); i++) {
            ...
            Order order = new Order(
                    ...
                    new Date(orderObject.getString("order_date")),
    ...
    private void groupOrdersByYear(List<Order> orders) {
        ...
        for (Order order : orders) {
            int year = order.getOrderDate().getYear() + 1900; // Year is offset by 1900
    ...
    public static class Order {
        ...
        public Order(int orderId, Date orderDate, String orderStatus, int totalItems, float totalPrice) {
