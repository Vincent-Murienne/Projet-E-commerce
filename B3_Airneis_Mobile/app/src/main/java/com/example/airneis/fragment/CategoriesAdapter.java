...
public class CategoryAdapter extends RecyclerView.Adapter<CategoriesAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.voirPlus.setOnClickListener(v -> {
            // Handle button click, you can add navigation to category details here
        });
    }
