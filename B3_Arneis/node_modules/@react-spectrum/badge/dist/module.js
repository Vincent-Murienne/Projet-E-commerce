import "./main.css";
import {useDOMRef as $ha4zE$useDOMRef, useStyleProps as $ha4zE$useStyleProps, classNames as $ha4zE$classNames, SlotProvider as $ha4zE$SlotProvider} from "@react-spectrum/utils";
import {filterDOMProps as $ha4zE$filterDOMProps} from "@react-aria/utils";
import $ha4zE$react, {forwardRef as $ha4zE$forwardRef} from "react";
import {Text as $ha4zE$Text} from "@react-spectrum/text";
import {useProviderProps as $ha4zE$useProviderProps} from "@react-spectrum/provider";
...
function $c2a9f60d7159b63f$var$Badge(props, ref) {
    let { children: children, variant: variant, ...otherProps } = (0, $ha4zE$useProviderProps)(props);
    let domRef = (0, $ha4zE$useDOMRef)(ref);
    let { styleProps: styleProps } = (0, $ha4zE$useStyleProps)(otherProps);
    let isTextOnly = (0, $ha4zE$react).Children.toArray(props.children).every((c)=>!/*#__PURE__*/ (0, $ha4zE$react).isValidElement(c));
    return /*#__PURE__*/ (0, $ha4zE$react).createElement("span", {
        ...(0, $ha4zE$filterDOMProps)(otherProps),
        ...styleProps,
        role: "presentation",
        className: (0, $ha4zE$classNames)((0, (/*@__PURE__*/$parcel$interopDefault($700c1b49452b6d47$exports))), "spectrum-Badge", {
            [`spectrum-Badge--${variant}`]: variant
        }, styleProps.className),
        ref: domRef
    }, /*#__PURE__*/ (0, $ha4zE$react).createElement((0, $ha4zE$SlotProvider), {
        slots: {
            icon: {
                size: "S",
                UNSAFE_className: (0, $ha4zE$classNames)((0, (/*@__PURE__*/$parcel$interopDefault($700c1b49452b6d47$exports))), "spectrum-Badge-icon")
            },
            text: {
                UNSAFE_className: (0, $ha4zE$classNames)((0, (/*@__PURE__*/$parcel$interopDefault($700c1b49452b6d47$exports))), "spectrum-Badge-label")
            }
        }
    }, typeof children === "string" || isTextOnly ? /*#__PURE__*/ (0, $ha4zE$react).createElement((0, $ha4zE$Text), null, children) : children));
}
/**
 * Badges are used for showing a small amount of color-categorized metadata, ideal for getting a user's attention.
 */ let $c2a9f60d7159b63f$export$37acb3580601e69a = /*#__PURE__*/ (0, $ha4zE$forwardRef)($c2a9f60d7159b63f$var$Badge);
