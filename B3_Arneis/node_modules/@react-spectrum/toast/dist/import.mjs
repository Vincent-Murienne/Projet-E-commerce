import $4ef3586572b5c0bd$exports from "./ar-AE.mjs";
import $9294a3bc0be7c803$exports from "./bg-BG.mjs";
import $2301cc9fa70c79b7$exports from "./cs-CZ.mjs";
import $db68d63440e07cc2$exports from "./da-DK.mjs";
import $59f85255004b972f$exports from "./de-DE.mjs";
import $897a62d7e05e3ae7$exports from "./el-GR.mjs";
import $cd5f6f9dc2665e8f$exports from "./en-US.mjs";
import $91da3b58720e2afa$exports from "./es-ES.mjs";
import $d881203a181403bc$exports from "./et-EE.mjs";
import $b39cb8320f170f5d$exports from "./fi-FI.mjs";
import $3dcec82c37bb9c69$exports from "./fr-FR.mjs";
import $70451b8bc8958a93$exports from "./he-IL.mjs";
import $8192b2e4907779a9$exports from "./hr-HR.mjs";
import $734bda6365304ddb$exports from "./hu-HU.mjs";
import $c985376db8169cb9$exports from "./it-IT.mjs";
import $0a814f0515b1f941$exports from "./ja-JP.mjs";
import $87900002a59b18f5$exports from "./ko-KR.mjs";
import $b083aee709113368$exports from "./lt-LT.mjs";
import $641d21187f9a9953$exports from "./lv-LV.mjs";
import $920b9baf5fdd305b$exports from "./nb-NO.mjs";
import $ac88c25d97133768$exports from "./nl-NL.mjs";
import $dea3c2ca37b0afea$exports from "./pl-PL.mjs";
import $36b701dae6c5c88a$exports from "./pt-BR.mjs";
import $959bf461c37c3856$exports from "./pt-PT.mjs";
import $584332ecb6a69cb1$exports from "./ro-RO.mjs";
import $b3a312739e8cca16$exports from "./ru-RU.mjs";
import $531de2843c7d5aa0$exports from "./sk-SK.mjs";
import $52846db7e4bedb0e$exports from "./sl-SI.mjs";
import $20c8bedbc8241336$exports from "./sr-SP.mjs";
import $7a9bac9c7f5066c3$exports from "./sv-SE.mjs";
import $ef512fc21e0fdf2f$exports from "./tr-TR.mjs";
import $6764c871b5447c7a$exports from "./uk-UA.mjs";
import $b1634d37b87f243f$exports from "./zh-CN.mjs";
import $19cbd4230357935e$exports from "./zh-TW.mjs";
import "./main.css";
import $jn1ib$react, {useRef as $jn1ib$useRef, useEffect as $jn1ib$useEffect, useContext as $jn1ib$useContext, createContext as $jn1ib$createContext} from "react";
import {ToastQueue as $jn1ib$ToastQueue, useToastQueue as $jn1ib$useToastQueue} from "@react-stately/toast";
import {useSyncExternalStore as $jn1ib$useSyncExternalStore} from "use-sync-external-store/shim/index.js";
...
import {useDOMRef as $jn1ib$useDOMRef, useStyleProps as $jn1ib$useStyleProps, classNames as $jn1ib$classNames} from "@react-spectrum/utils";
...
import {mergeProps as $jn1ib$mergeProps} from "@react-aria/utils";
import {Provider as $jn1ib$Provider} from "@react-spectrum/provider";
import $jn1ib$reactdom from "react-dom";
import {useFocusRing as $jn1ib$useFocusRing} from "@react-aria/focus";
...
const $e46feef4e4c28a4b$export$9194c0aa0cd7a9ff = /*#__PURE__*/ (0, $jn1ib$createContext)(false);
function $e46feef4e4c28a4b$export$fb98e3a2a4cd92d7(props) {
    ...
    let { focusProps: focusProps, isFocusVisible: isFocusVisible } = (0, $jn1ib$useFocusRing)();
    let contents = /*#__PURE__*/ (0, $jn1ib$react).createElement((0, $jn1ib$Provider), {
        UNSAFE_style: {
            background: "transparent"
        }
    }, /*#__PURE__*/ (0, $jn1ib$react).createElement($e46feef4e4c28a4b$export$9194c0aa0cd7a9ff.Provider, {
        value: isFocusVisible
    }, /*#__PURE__*/ (0, $jn1ib$react).createElement("div", {
        ...(0, $jn1ib$mergeProps)(regionProps, focusProps),
        ref: ref,
...
function $7e7a2952509f3a56$var$Toast(props, ref) {
    ...
    let stringFormatter = (0, $jn1ib$useLocalizedStringFormatter)((0, (/*@__PURE__*/$parcel$interopDefault($41e47081d30453d1$exports))), "@react-spectrum/toast");
    ...
    let isFocusVisible = (0, $jn1ib$useContext)((0, $e46feef4e4c28a4b$export$9194c0aa0cd7a9ff));
    const handleAction = ()=>{
...
function $02c59b34bd70955a$var$useActiveToastContainer() {
    return (0, $jn1ib$useSyncExternalStore)($02c59b34bd70955a$var$subscribe, $02c59b34bd70955a$var$getActiveToastContainer, $02c59b34bd70955a$var$getActiveToastContainer);
}
